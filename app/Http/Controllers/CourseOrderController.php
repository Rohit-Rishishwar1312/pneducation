...
class CourseOrderController extends Controller
{
    public function insert(Request $a)
    {
    	...
    	// print_r($cartproduct);
    	if($co['payment_method']=="pay by cash on delivery")
        {
    ...
    $paramList["ORDER_ID"] = $orderr_id;
    $paramList["CUST_ID"] = $orderr_id;
    ...
    public function thank()
    {
        ...
        return view('front.thanks',Compact('navf'));
    }
}
