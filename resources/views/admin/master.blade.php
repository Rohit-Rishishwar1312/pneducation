...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('admin/navfoot')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Navbar/Footer
          ...
          <li class="nav-item">
            <a href="{{url('admin/learn')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Learn Content
 ...
 @show 
  ...
  <footer class="main-footer bg-dark">
    <strong>Copyright &copy; 2021 <a href="http://adminlte.io">Admin Panel</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Rohit</b> Rishishwar
    </div>
  </footer>
