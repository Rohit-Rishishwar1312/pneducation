...
@section("content")
  ...
  <div class="content-wrapper">
    ...
    <h1 style="padding-left: 20px;">Edit Coupan Details</h1><br><br>
    <div style="padding-left: 20px;padding-right: 70px;">
      <form method="post" action="{{url('addcoupan/update')}}">
      @csrf
      <input type="hidden" name="id" value="{{$edit->id}}">
    Coupan Code:
      <input type="text" name="coupan_code" value="{{$edit->coupan_code}}" class="form-control"><br><br>
    Amount:
      <input type="text" name="amount" value="{{$edit->amount}}" class="form-control"><br><br>
    Amount Type: 
